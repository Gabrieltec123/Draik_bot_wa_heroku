    ...
    */
    ...
    if (config.LANG == 'EN' || config.LANG == 'ES') {
        QueenAmdiCon.on('open', async() => {
            ...
            console.log(
                chalk.green.bold('🛡️ Draik_bot Sheild Activated!')
            );
                            ...
                            if (config.LANG == 'SI') {
                                ...
                                if (error.message.includes('URL')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n\n*විසඳුම:* _LOG අංකය හැර ඕනෑම චැට් එකකදී ඔබට විධානයන් භාවිතා කළ හැකිය._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _Restart කිරීම ප්‍රමාණවත් වේ._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _ඔබ එය තවත් වරක් භාවිතා කළහොත් ගැටළුව විසඳනු ඇත._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _ඔබ අකුරු රාමුව තුළ ඇති විධානය භාවිතා කළහොත් ගැටළුව විසඳනු ඇත._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _කරුණාකර ඔබේ plugin කේත පරීක්‍ෂා කරන්න._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _ටික වේලාවක් බලා නැවත උත්සාහ කරන්න. ඔබ තවමත් දෝෂයක් ලබා ගන්නේ නම්, වෙබ් අඩවියේ ගනුදෙනුව සිදු කරන්න._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _මෙම දෝෂය සඳහා විසඳුමක් නොමැත. එය fatal error නොවේ._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _ඔබ එය නැවත භාවිතා කළහොත් එය වැඩිදියුණු විය හැකිය. දෝෂය දිගටම පැවතුනහොත්, ඔබට restart කිරීමට උත්සාහ කළ හැකිය._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _Panel විස්තරයේ ලියා ඇති පරිදි කරුණාකර විධානයන් භාවිතා කරන්න._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _මිනිත්තු කිහිපයක් රැඳී සිටින්න. Developers විසින් මෙම දෝෂය නිවැරදි කරනු ඇත._', MessageType.text
                                    );
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*විසඳුම:* _ඔබ English හෝඩියේ විධානය භාවිතා කළහොත් ගැටළුව විසඳනු ඇත._', MessageType.text
                                    );
                                } else {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*🙇🏻 කණගාටුයි, මට මෙම දෝෂය කියවිය නොහැක! 🙇🏻*' +
                                        '\n_වැඩිදුර උදව් සඳහා ඔබට අපගේ support කණ්ඩායම් වෙත ලිවිය හැකිය._', MessageType.text
                                    );
                                }
                            } else {
                                ...
                                if (error.message.includes('URL')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*Solution:* _You can use commands in any chat, except the LOG number._', MessageType.text
                                    );
                                } else if (error.message.includes('split')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _Restarting will be enough._', MessageType.text
                                    );
                                } else if (error.message.includes('Ookla')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _If you use it one more time the problem will be solved._', MessageType.text
                                    );
                                } else if (error.message.includes('params')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _The problem will be solved if you use the command in Latin letters frame._', MessageType.text
                                    );
                                } else if (error.message.includes('unlink')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved``` ==========' +
                                        ...
                                        '\n\n*Solution:* _Please check the your plugin codes._', MessageType.text
                                    );
                                } else if (error.message.includes('404')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _Wait a while and try again. If you still get the error, perform the transaction on the website.._', MessageType.text
                                    );
                                } else if (error.message.includes('reply.delete')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _There is no solution for this error. It is not a fatal error._', MessageType.text
                                    );
                                } else if (error.message.includes('load.delete')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*Solution:* _If you use it again, it may improve. If the error continues, you can try to restart._', MessageType.text
                                    );
                                } else if (error.message.includes('decode')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _Please use the commands as written in the plugin description._', MessageType.text
                                    );
                                } else if (error.message.includes('500')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                        ...
                                        '\n\n*Solution:* _Wait for few minutes. This error will fixed By Developers._', MessageType.text
                                    );
                                } else if (error.message.includes('503')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [QUEEN AMDI] ⚜️*' +
                                        ...
                                        '\n\n*Solution:* _The problem will be solved if you use the command in Latin alphabet.._', MessageType.text
                                    );
                                } else {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*' +
                                        '\n_You can write to our support groups for more help._', MessageType.text
                                    );
                                }
                            }
                        }
