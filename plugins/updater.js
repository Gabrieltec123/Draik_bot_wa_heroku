/* Copyright (C) 2021 Draik_bot - GabrielTec.

Licensed under the  GPL-3.0 License;
you may not use this file except in compliance with the License.

Draik_bot - GabrielTec
*/
...
var Action = ''
if (Config.LANG == 'SI') Action = '*👸🏻 Draik_bot Updating...*'
if (Config.LANG == 'EN' || Config.LANG == 'ES') Action = '*👸🏻 Draik_bot Updating...*'
