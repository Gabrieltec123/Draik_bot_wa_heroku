...
module.exports = {
    VERSION: 'Draik_bot 3.0.2v - Public Stable',
    ...
    CAP:  process.env.CAP  ===  undefined  ?  'ᴳᵉⁿᵉʳᵃᵗᵉᵈ ᴮʸ Draik_bot₂₀₂₁'  :  process.env.CAP,
    ...
    WELCOME_LOGO:  process.env.WELCOME_LOGO  ===  undefined  ?  'https://i.ibb.co/f4ZH2Sk/descarga-1.png'  :  process.env.WELCOME_LOGO,
